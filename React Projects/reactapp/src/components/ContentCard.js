...
export default function ContentCard() {
  ...
  const [btColor, setBtColor] = useState("#D32F2F")
  const [bgColor, setBgColor] = useState("#F1F2FD")
  const [txtColor, setTxtColor] = useState("#313771")
  const [clicked,setClicked] = useState(false)
  const [visible,setVisible] = useState(true)
  const [textBt,setTextBt] = useState("cancel")
  const [txtupload,setTxtUpload] = useState("Uploading 99")
  ...
  return (
    ...
    <Grid container spacing={2} alignItems="center" justifyContent="center" sx={{ padding: "7%",marginLeft:"1%" }}>
              ...
              >
                ...
                <Grid item md={4} xs={12}>
                  <Box
                    ...
                    sx={{
                      '& > :not(style)': { m: 1, width: '172px', height: "56px", paddingRight: "3%" },
                    }}
          ...
          {dataCards.map((datacard, index) => {
            return (
              <React.Fragment key={index} >
                ...
                <Grid item md={6} xs={12} id={datacard.id}>

                  <DataPaperDone url={datacard.value}  btColor={btColor} bgColor={bgColor} txtColor={txtColor}  visible={visible} textBt={textBt} txtupload={txtupload} doCancel={doCancel} />
                </Grid>
